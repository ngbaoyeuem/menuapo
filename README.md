...
## 📥 Tải Về Bản Cài Đặt (Releases v38.0)

👉 **[Bấm vào đây để vào mục Releases v38.0 tải file](https://github.com/ngbaoyeuem/menuapo/releases/tag/v38.0)**

### Danh sách file phát hành:
1. **`ApoMicCrusher.ipa`**: Cài đặt ứng dụng iOS trực tiếp qua TrollStore, Sideloadly, ESign, Scarlet, AltStore.
2. **`com.ngbao.apocrusher_38.0_iphoneos-arm64.deb`**: Tweak hệ thống cho máy Jailbreak / TrollStore, tự động kích hoạt mic booster cho 100% app trong máy.
